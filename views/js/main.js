...
var resizePizzas = function(size) {
  ...
  function changeSliderLabel(size) {
    // Using a Variable to prevent repeated calling 
  ...
  function changePizzaSizes(size) {
    ...
    switch (size) {
      ...
      case "3" :
        ...
        break ;
      default :
        console.log("Bug in the Function : sizeSwitcher");
    }

    var randomPizza = document.getElementsByClassName('randomPizzaContainer');

    var length = randomPizza.length;
...
function updatePositions() {
  ...
  // document.body.scrollTop is declared outside the loop, should prevent FSL
